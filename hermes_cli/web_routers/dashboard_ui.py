...
async def post_agent_plugin_enable(request: Request, name: str):
    return await _named_plugin_action(request, name, lambda n: _set_agent_plugin_enabled_with_restart_hint(n, enabled=True),
                                      "Enable failed.", rescan=False)


@router.post("/api/dashboard/agent-plugins/{name:path}/disable")
async def post_agent_plugin_disable(request: Request, name: str):
    return await _named_plugin_action(request, name, lambda n: _set_agent_plugin_enabled_with_restart_hint(n, enabled=False),
